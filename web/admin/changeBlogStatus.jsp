                    ...
                    <div class="templatemo-content-container">
                        ...
                        <form action="../BlogController?op=changeStatus" method="post">
                            <div class="card" class="col col-md-6 col-lg-6" style="font-size:20px;font-family: corbel;">
                                ...
                                <img class="card-img-top" src="../<%=blog.getPoster()%> " alt="Card image" style="width:350px;height: 400px; border-radius: 20px;">
                                <div class="card-body">
                                    <h4><%=blog.getTitle() %></h4>
                                    ...
                                    <p class="form-group"><b>Change Status </b> :<br/>
                                        <select name="status" class="dropdown-divider">
                                            ...
                                            <option value="rejected" <%=blog.getStatus().equals("rejected")?"selected":""%>>Rejected/Denied</option>
                                        </select>
                                    </p>
